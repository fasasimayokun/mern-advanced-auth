            ...
            {!isSubmitted ? (
                <form onSubmit={handleSubmit}>
                    <p className='text-gray-300 mb-6 text-center'>
                        Enter your email address and we'll send you a link to reset or password.
                    </p>
                    ...
                    <motion.button
                        ...
                        rounded-lg shadow-lg hover:from-green-600 hover:to-emerald-700 focus:outline-none foucs:ring-2
